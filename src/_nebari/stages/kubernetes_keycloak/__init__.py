...
class Keycloak(schema.Base):
    ...
    keycloak_nebari_bot_password: str = Field(default_factory=random_secure_string)
    keycloak_view_only_user_password: str = Field(default_factory=random_secure_string)
